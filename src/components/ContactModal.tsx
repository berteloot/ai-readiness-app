        ...
        {!result ? (
          ...
          <>
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-card">
                <img src="/lsg_icon_email-01.svg" alt="Email Icon" className="w-16 h-16" />
              </div>
