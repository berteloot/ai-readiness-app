      ...
      <div className="bg-white shadow-card border-b border-border-subtle">
        <div className="max-w-4xl mx-auto mobile-optimized py-16 sm:py-20 md:py-28">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-text-primary mb-4 sm:mb-6 leading-tight">
              Evaluate your organization&apos;s readiness for AI transformation in Customer Experience (CX).
            </h1>
